...
if __name__ == '__main__':
    ...
    my_stopwords = set(['singletrack', 'loop', 'trail', 'trails',  'ride', 'area', 'route', 'way', 'feature', 'section','sections', 'riding', \
                    'loop','br', 'mile', 'miles', 'right', 'left', 'www', 'http', 'https', 'bike', 'bikes', 'bicycle', 'bicycles', \
                    'continue', 'rider', 'riders', 'parking', 'lot', 'turn', 'start', \
    ...
    # Create TF matrix
    tf_vect = make_vectorizer(X, tf_idf=False, lemmatize=True, max_df=0.8, min_df=2, max_features=1000, stop_words=all_stopwords, ngram_range=(1, 2))
